...
define("dist/js/sign", [ "public/lib/jquery", "lib/jquery-plugins/bootstrap-tooltip", "lib/jquery-plugins/jqBootstrapValidation" ], function(require) {
    ...
    function checkUnique(ele, warning, name, email) {
        ...
        $.ajax({
            ...
            success: function(data) {
                if (!data) {
                    $that.parent(".control-group").addClass("warning").removeClass("success").find(".help-block").html('<ul role="alert"><li>' + warning + "已存在</li></ul>");
                } else if (!email) {
    ...
    $("#usernamesignup").on("keyup paste", function() {
        ...
        if (!$(this).val().trim()) {
            $(this).parent(".control-group").addClass("warning").removeClass("success").find(".help-block").html('<ul role="alert"><li>用户名不能为空白</li></ul>');
        }
    });
});
