define("dist/js/util", [ "libs/jquery", "libs/twitter-text", "libs/jquery-plugins/drag", "libs/moment" ], function(require, exports, module) {
...
!function($) {
    ...
    typeof define == "function" && define("moment", [], function() {
        return t;
    });
}).call(this);
...
(function() {
    function e(e) {
        e.lang("zh-cn", {
            ...
            meridiem: function(e, n) {
                return 9 > e ? "早上" : 11 > e && 30 > n ? "上午" : 13 > e && 30 > n ? "中午" : 18 > e ? "下午" : "晚上";
            },
            calendar: {
                sameDay: "[今天]LT",
                nextDay: "[明天]LT",
    ...
    "function" == typeof define && define([ "moment" ], e), "undefined" != typeof window && window.moment && e(window.moment);
})();

(function() {
    var a, b, c, d, e, f, g;
    moment.fn.twitter = moment.fn.twitterLong = function() {
        return f.call(this, "long");
    }, moment.fn.twitterShort = function() {
        return f.call(this, "short");
    }, f = function(f) {
        var h, i, j, k;
        if (h = Math.abs(this.diff(moment())), j = null, i = null, e >= h) j = "seconds", 
        i = 1; else if (d > h) j = "seconds"; else if (c > h) j = "minutes"; else if (a > h) j = "hours"; else {
            if ("short" !== f) return this.format("MMMD日");
            if (!(g > h)) return this.format("M/D/YY");
            j = "days";
        }
        return i && j || (i = moment.duration(h)[j]()), k = j = b[j][f], i + k;
    }, e = 1e3, d = 6e4, c = 36e5, a = 864e5, g = 6048e5, b = {
        seconds: {
            "short": "秒",
            "long": "秒"
        },
